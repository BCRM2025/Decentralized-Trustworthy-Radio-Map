...
class Block(Message):
    __slots__ = ['__blockhead', 'height', 'blockhash', 'isAdversaryBlock', 'next', 'parentblock', 'isGenesis', 'state', 'round', 'sensor_data', 'map']
    ...
    def __init__(self, name=None, blockhead: BlockHead = None, height = None,
                 state = None, round = None, isadversary=False, isgenesis=False,
                 blocksize_MB=2, sent_data=np.array([]).reshape(-1, 5), Map=None):
